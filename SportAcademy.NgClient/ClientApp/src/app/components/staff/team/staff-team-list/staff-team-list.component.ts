...
@Component({
  selector: 'app-staff-team-list',
  templateUrl: './staff-team-list.component.html',
  styleUrls: ['./staff-team-list.component.scss']
})
export class StaffTeamListComponent implements OnInit {
