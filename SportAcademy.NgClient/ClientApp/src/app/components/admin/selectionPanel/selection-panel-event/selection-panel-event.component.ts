...
@Component({
  selector: 'app-selection-panel-event',
  templateUrl: './selection-panel-event.component.html',
  styleUrls: ['./selection-panel-event.component.scss']
})
export class SelectionPanelEventComponent implements OnInit {
