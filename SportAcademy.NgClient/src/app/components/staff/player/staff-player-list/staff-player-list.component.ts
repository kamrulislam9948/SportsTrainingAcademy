...
@Component({
  selector: 'app-staff-player-list',
  templateUrl: './staff-player-list.component.html',
  styleUrls: ['./staff-player-list.component.scss']
})
export class StaffPlayerListComponent implements OnInit {
