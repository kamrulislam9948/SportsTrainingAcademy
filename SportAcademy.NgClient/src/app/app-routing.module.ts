...
const routes: Routes = [
  ...
  [
    ...
    {path: 'player-player-list', component: PlayerPlayerListComponent, canActivate: [authGuardFnGuard(['Players'])]},
    {path: 'player-team-list', component: PlayerTeamListComponent, canActivate: [authGuardFnGuard(['Players'])]},
