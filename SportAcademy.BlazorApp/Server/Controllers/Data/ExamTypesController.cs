...
namespace SportAcademy.BlazorApp.Server.Controllers.Data
{
    ...
    public class ExamTypesController : ControllerBase
    {
        ...
        public ExamTypesController(SportsEdgeDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<ExamType>> PostExamType(ExamType examType)
        {
            if (_context.ExamTypes == null)
            {
                return Problem("Entity set 'SportsEdgeDbContext.ExamTypes'  is null.");
            }
        ...
        {
            return (_context.ExamTypes?.Any(e => e.ExamTypeId == id)).GetValueOrDefault();
        }
    }
}
